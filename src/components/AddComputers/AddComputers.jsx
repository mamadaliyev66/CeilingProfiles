...
export default function AddComputers() {
...
<label className="input input-bordered flex items-center gap-2 transition-all ease-in-out duration-300">
  Name:
  <input onChange={((e)=>{setNomi(e.target.value)})} type="text" className="grow transition-all ease-in-out duration-300" placeholder="White Beam Profiles" />
</label>

<label className="input input-bordered flex items-center gap-2 transition-all ease-in-out duration-300">
  ID (Profile Code):
  <input onChange={((e)=>{setCpu(e.target.value)})} type="text" className="grow transition-all ease-in-out duration-300" placeholder=" SZ-592" />
</label>

<label className="input input-bordered flex items-center gap-2 transition-all ease-in-out duration-300">
  Qo'shimcha Malumotlar:
  <input onChange={((e)=>{setDescription(e.target.value)})} type="text" className="grow transition-all ease-in-out duration-300" placeholder="Color : White, ......" />
</label>
